...
export default class PublicController extends Controller {
  ...
  public async findClinics() {
    const result = await this.publicService.findClinics(
  ...
  public async findAppointments() {
    const result = await this.publicService.findAppointments(
      this.ctx.request.body.conditions
    );
    this.ctx.body = { success: true, result };
  }
  ...
  public async checkinAppointment() {
    const result = await this.publicService.checkinAppointment(
      this.ctx.request.body.conditions
    );
    this.ctx.body = { success: true, result };
  }
  ...
  public async findDoctors() {
    const result = await this.publicService.findDoctors(
      this.ctx.request.body.conditions
    );
    this.ctx.body = { success: true, result };
  }
